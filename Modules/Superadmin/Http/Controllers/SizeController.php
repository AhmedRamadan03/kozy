...
class SizeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('superadmin::sizes.index',[
    ...
    {
        return view('superadmin::sizes.form' ,[
            'resource' => $this->model,
        ]);
    }
    ...
    public function update(StoreColorAndSizeRequest $request, $id)
    {
        ...
        setLogs('update', 'size', $resource, $logData );
    ...
    public function destroy($id)
    {
        ...
        setLogs('delete', 'size', $data,$data->toArray()  );
        $data->delete();
