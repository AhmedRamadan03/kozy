    ...
    <div class="row pt-4">
        <div class="col-md-12">
            @component('superadmin::layouts.includes.card', [
                ...
                @slot('content')
                    <form action="{{ route('admin.report.trendingProducts') }}" method="GET">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 pt-4">
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('admin.report.trendingProducts') }}" class="btn w3-light-grey"> <i
                ...
                @slot('content')
                    @component('superadmin::layouts.includes.table')
                        @slot('headers')
                            ...
                            @endif
                            <td>{{ __('lang.name') }}</td>
                            <td>{{ __('lang.sale_quantity') }}</td>
                            <td>{{ __('lang.sale_cost') }}</td>
