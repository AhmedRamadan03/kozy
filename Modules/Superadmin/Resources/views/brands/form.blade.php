@php
    $title = $resource->id ?  __('lang.edit') .' ' . __('lang.brand')   : __('lang.add') .' ' . __('lang.brand');
@endphp
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        ...
        <form class="form" action="{{ $resource->id?route('admin.brand.update',$resource->id):route('admin.brand.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                <div class="row">
