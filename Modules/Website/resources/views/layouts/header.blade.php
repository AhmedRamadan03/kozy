      ...
      <div class="container">
          <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="item d-flex gap-3">
                  @if (auth()->check())
                      <a onclick="event.preventDefault();document.getElementById('logout-form').submit();"
                          class="text-dark" href="{{ route('front.logout') }}"> {{ __('front.logout') }}
                      </a>
                  ...
                  <a class=" " href="{{ route('front.contact-us') }}"><b
                          class="">{{ __('front.need_help') }}</b> </a>
                  <span style="width: 1px; height: 25px; background-color: white"></span>
              ...
              <div class="item d-flex gap-3">
                  <div class=" nav-item dropdown">
                      <a class="nav-link text-dark dropdown-toggle" data-bs-toggle="dropdown">
                          <span class="text-dark">
                              <img src="{{ asset(session('country')->image) }}" width="30" height="30"
                                  alt="">
                      ...
                      <div class="dropdown-menu p-0" style="min-width: 225px;top:0px;z-index: 9999">
                          @foreach ($countrieH as $item)
                              <a class="dropdown-item w3-border-bottom p-3"
                                  href="{{ route('front.updateSession') }}?country_id={{ $item->id }}">
                                  <i>
                                      <img src="{{ asset($item->image) }}" width="30" height="30"
                                          alt="">
                                      {{ $item->currency }}
                                  </i>
                              </a>
                  ...
                  <div class=" nav-item dropdown">
                      <a class="nav-link text-dark dropdown-toggle" data-bs-toggle="dropdown">
                          <span class="text-dark"> {{ App::getLocale() == 'en' ? 'English' : 'العربية' }} </span>
                      </a>
                      <div class="dropdown-menu p-0" style="min-width: 225px;top:0px;z-index: 9999">
          ...
          <nav class="navbar navbar-expand-lg  sticky-top ">
              ...
              <div class="d-flex  gap-4">
                  ...
                  <a href="{{ route('front.cart.cart') }}" class="text-dark position-relative">
                      ...
                      <span
                          class="position-absolute cart--count shadow top-0 start-100 translate-middle badge rounded-pill">{{ $cart_count ?? 0 }}</span>
                  </a>
                  @if (auth()->check())
                      <div class="nav-item dropdown">
                          <a class="nav-link text-dark dropdown-toggle" data-bs-toggle="dropdown">
                          ...
                          <div class="dropdown-menu p-2" style="min-width: 225px;top:0px;z-index: 9999">
                              <a class="dropdown-item"
                                  href="{{ route('front.profile.index') }}">{{ __('front.profile') }}
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                              ...
                              <a onclick="event.preventDefault();document.getElementById('logout-form').submit();"
                                  class="dropdown-item" href="{{ route('front.logout') }}"> {{ __('front.logout') }}
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
      ...
      <div class="modal-dialog modal-dialog-centered ">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">{{ __('lang.search') }} </h5>
